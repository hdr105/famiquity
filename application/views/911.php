...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "911", "txt3" => "")); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="mb-20 sub-pages">
                    <h3>Police, Firemen and Emergency professionals are subject to higher levels of risks of relationship breakdowns due to the combination of shift work, positions of power, and time spent with partners in the field.  Being a Government funded profession supported by strong Unions, their incomes and pensions are healthy.  The financial risk increases if their spouses/partners are stay at home or low income earners.</h3>

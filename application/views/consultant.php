...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "Consultants", "txt3" => "")); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="mb-20 sub-pages">
                    <h3>Professionals and self employed consultants are subject to higher levels of risks of relationship breakdowns due to the combination of long hours, business travel and perceived expertise.  Accountants typically advise tax saving strategies that are costly in the event of relationship breakdown.  The financial risk increases if their spouses/partners are stay at home or low income earners.</h3>

...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "High Finance", "txt3" => "")); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="mb-20 sub-pages">
                    <h3>Traders, Actuaries, Accountants, Brokers, and Financial Industry Executives in Finance are subject to higher levels of risks of relationship breakdowns due to the combination of long hours, business socializing and positions of power.  It’s perceived as a well paid profession and the financial risk increases if their spouses/partners are stay at home or low income earners.</h3>

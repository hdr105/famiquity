...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "Addictions", "txt3" => "")); ?>
    <div class="container form-margin">
        <?php
            echo form_open(base_url('save-addiction-info'), array("METHOD"=>"POST"));
        ?>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div id="register-form" class="register-form">
                    <div class="section-field">
                        <label><?php echo $this->labelArray['has_addiction_problem'];?></label>
                        <div class="input-group">
                            <select class="Wide fancyselect1" name="has_addiction_problem" style="width: 100%;">
                                <?php echo Smart::selectList($list, 'id', 'name', Smart::setValue('has_addiction_problem', $app->has_addiction_problem)); ?>
                            </select>

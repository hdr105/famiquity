...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "Nights Out", "txt3" => "")); ?>
    <div class="container form-margin">
        <?php
            echo form_open(base_url('save-nights-without-spouse'), array("METHOD"=>"POST"));
        ?>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div id="register-form" class="register-form">
                    <div class="section-field">
                        <label><?php echo $this->labelArray['night_without_s'];?></label>
                        <div class="input-group">
                            <select class="Wide fancyselect1" name="night_without_s" style="width: 100%;">
                                <?php echo Smart::selectListNumber(Smart::setValue('night_without_s', $app->night_without_s),0,31); ?>
                            </select>

...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "Spouse not Home", "txt3" => "")); ?>
    <div class="container form-margin">
        <?php
            echo form_open(base_url('save-nights-without-you'), array("METHOD"=>"POST"));
        ?>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div id="register-form" class="register-form">
                    ...
                    <div class="section-field">
                        <label><?php echo $this->labelArray['s_nights_without_you'];?></label>
                        <div class="input-group">
                            <select class="Wide fancyselect1" name="s_nights_without_you" style="width: 100%;">
                                <?php echo Smart::selectListNumber(Smart::setValue('s_nights_without_you', $app->s_nights_without_you),0,31); ?>
                            </select>

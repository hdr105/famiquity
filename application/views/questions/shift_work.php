...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "Shift Work", "txt3" => "")); ?>
    <div class="container form-margin">
        <?php
            echo form_open(base_url('save-shift-work'), array("METHOD"=>"POST"));
        ?>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div id="register-form" class="register-form">
                    ...
                    <div class="section-field">
                        <label><?php echo $this->labelArray['do_shift_work'];?></label>
                        <div class="input-group">
                            <select class="Wide fancyselect1" name="do_shift_work" style="width: 100%;">
                                <?php echo Smart::selectList($list, 'id', 'name', Smart::setValue('do_shift_work', $app->do_shift_work)); ?>
                            </select>

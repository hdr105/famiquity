                ...
                <div id="register-form" class="register-form">
                    ...
                    <div class="section-field">
                        ...
                        <div class ='field-widget'>
                            <input type="number" min="0" step="10000" class="web form-control"  autocomplete="off" name="trust_income_draw_amount"  value="<?php echo Smart::setValue('trust_income_draw_amount', $app->trust_income_draw_amount); ?>"

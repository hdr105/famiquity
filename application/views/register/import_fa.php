...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "Import Financial Advisors", "txt3" => "")); ?>
    <div class="container form-margin">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <a href="<?php echo base_url('add-advisor'); ?>" class="button">Add Advisor</a>
        ...
        <div class="row mt-20">
            <?php
            echo form_open_multipart(base_url('import-fa'), array("method" => "POST"));
            ?>
            <div class="col-md-6 col-md-offset-3">
                <h4>Bulk Import</h4>
                <?php
                ...
                <div id="register-form" class="register-form">
                    <div class="section-field">
                        <span class="small">Browse and Select advisors list for each Institute for which you want to import advisors.<br><a href="<?php echo Smart::loadAsset('docs/advisor-sample.csv')?>">Click here</a> to download sample file.</span>
                        <br><br>

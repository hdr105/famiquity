...
<section class="gray-bg page-section-ptb o-hidden">
    <?php $this->load->view('shared/_page_header', array("txt1" => "", "txt2" => "Teachers", "txt3" => "")); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="mb-20 sub-pages">
                    <h3>Teachers are subject to higher levels of risks of relationship breakdowns due to the combination of time off work, and stressful daily schedules during the school year.  Being a Government funded profession supported by strong Unions, Teachers are well educated, well paid, and have a very strong pension.  The financial risk increases if their spouses/partners are stay at home or low income earners.</h3>
